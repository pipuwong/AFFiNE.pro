<template lang="pug">
.community-navbar
  nuxt-link.nav-sub-item.flex.gap-3.mb-2px(
...
const navItems = [
  ...
  {
    name: 'Telegram',
    desc: 'Best place for instant engagement with peers',
    icon: 'telegram',
